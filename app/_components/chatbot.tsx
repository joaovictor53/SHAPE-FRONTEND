...
export function Chatbot({ inline }: ChatbotProps) {
  ...
  const chatContent = (
    <div className={cn("flex flex-col bg-background", inline ? "min-h-svh flex-1" : "flex-1 overflow-hidden rounded-[20px]")}>
