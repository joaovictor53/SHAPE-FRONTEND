...
import { getWorkoutDayById, getHomeData, getUserTrainData } from "@/app/_lib/api/fetch-generated";
...
export default async function WorkoutDayPage({
  ...
  return (
    <div className="flex min-h-svh flex-col bg-background pb-24">
      ...
      <div className="px-5">
        <div className="relative flex h-[200px] w-full flex-col items-start justify-between overflow-hidden rounded-xl bg-foreground p-5">
          {coverImageUrl && (
            <Image
              src={coverImageUrl}
              alt={name}
